                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="hero-banner imgEffect2 o-hidden radius-20">
                            ...
                            <!-- shape 01 -->
                            <div class="shape">
                                <img src="assets/images/icon/feature-shape.png" alt="smartBTR">
                            </div>
                            <a href="https://youtu.be/3WblMMl02QE" data-fancybox="video-gallery" class="wow bounceIn" data-wow-delay=".2s">
                                ...
                                <div class="comment-section">
                                    <div class="main-profile">
                                        ...
                                        <div class="user-info">
                                           ...
                                           <p class="pera"style="text-align: justify;">Bodoland Territorial Region (BTR) is an autonomous region within the state of Assam with the total population of 31,55,395 residing in 8970 sq km area....<span style="font-size: 13px;
                                        ...
                                        <div class="why-points">
                                            <div class="why-point">
                                                ...
                                                <div class="why-content">
                                                    ...
                                                    <p class="pera line-clamp-3" style="text-align: justify;">
                                        ...
                                        <div class="why-points">
                                            <div class="why-point">
                                                ...
                                                <div class="why-content">
                                                   ...
                                                   <a href="history"> <span style="width: 100px; margin-left: auto; font-size: 13px;font-weight: 700;color: #fff;background-color: #f9710e;padding: 2px 8px 2px;border-radius: 5px">READ MORE</span>
                                                   </a>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide testimonial-card-two h-calc">
                                    ...
                                    <div class="testimonial-footer">
                                        <div class="all-user">
                                            <div class="happy-user">
                                                <img src="assets/images/gallery/chief.jpg" alt="smartBTR">
                                            </div>
                ...
                <div class="row g-4">
                    ...
                    <style>
                        ...
                        <div class="col-xl-5 col-lg-5 m-30" style="padding: 0px 16px;" >
                            <h4 class="title" style="font-size: 24px;font-weight: 700;">Useful Links</h4>
                        <div class="row g-4 position-sticky top-0">
                            <div class="col-lg-12">
            ...
            <div class="container citizen-content">
                ...
                <div class="row g-4 mt-10" style=" background-image: linear-gradient(to left, rgb(202, 169, 169), rgba(255,0,0,1)); padding: 11px; border-radius: 10px;">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4">
                        <a href="#citizenServiceModal" class="clickService" data-citizenService="Grievance" data-bs-toggle="modal">
