...
(function ($) {
    ...
    var swiper = new Swiper(".destinationSwiper-active", {
        ...
        autoplay: {
            ...
            //***  update code to avoid infinite tab changing 
    ...
    ----------------------------------------------*/
    var destination = [
    { id: "", text: "SELECT DISTRICT", description: "" },
    { id: "", text: "SELECT ULB", description: "" },
...
const districtPlaces = {
    "Kokrajhar": ["Gossaigaon", "Kokrajhar", "Fakiragram"],
    "Chirang": ["Bijni", "Kajalgaon", "Basugaon"],
    "Baksa": ["Goreswar"],
    "Udalguri": ["Tangla"],
...
$(".destination-dropdown.district-dropdown").select2({
...
// Open Select2 dropdown on title click
$(".select2-title").on('click', function() {
    var $select = $(this).closest('.select-dropdown-section').find('select');
    $select.select2('open');
});

// Handle change event of district dropdown
$(".destination-dropdown.district-dropdown").on('change', function() {
    const selectedDistrict = $(this).val();
    const ulbDropdown = $(this).closest('.plan-section').find('.destination-dropdown.ulb-dropdown');

    ulbDropdown.empty();

    ulbDropdown.append('<option value="" selected disabled>SELECT ULB</option>');

    if (selectedDistrict && districtPlaces[selectedDistrict]) {
        districtPlaces[selectedDistrict].forEach(place => {
            ulbDropdown.append(`<option value="${place}">${place}</option>`);
        });
