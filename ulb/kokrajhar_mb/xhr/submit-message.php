...
if (isset($_POST['category'])) {
    ...
    // Count if the user's email and category (subject) combination already exists
    $countUser = $crud->Count("citizen_grievance", "`email`='$email' AND `subject`='$category'");
    
    // if ($countUser > 0) {
    //     $data['errorMessage'] = "Your message is already in our records.";
    // } else {
