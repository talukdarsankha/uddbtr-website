...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        initializeCKEditor("#introduction", "globalEditor");
        initializeCKEditor("#editIntroduction", "globalEditor2");
    });
</script>
            ...
            <div class="content-wrapper">
               ...
               <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="modal-dialog">
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="backDropModalTitle">Add Introduction</h5>
                  ...
                  <div class="card" style="margin-top: 20px">
                     <div class="card-header border-bottom">
                        <h5 class="card-title">View Introduction</h5>
                     </div>
                     <div class="card-datatable table-responsive" style="padding: 20px">
                        <table id="example" class="datatables-users"style="width:100%; padding: 20px">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 <td><?php echo ++$n; ?></td>
                                 <td style="text-align:justify;"><?php echo $intro['introduction']; ?></td>
                                 <td>
                                  <a href=""data-bs-toggle="modal" data-id="<?php echo $intro['id']; ?>" data-bs-target="#backDropModal2" target="_blank" class="btn btn-danger btn-buy-now btn-sm edit">Edit</a>
                                </td>
                              </tr>
                              <?php }}?>
                           </tbody>
               ...
               <div class="modal fade" id="backDropModal2" data-bs-backdrop="static" tabindex="-1">
                        <div class="modal-dialog">
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="backDropModalTitle">Edit Introduction</h5>
                                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              ...
                              <div class="modal-body">                               
                                 ...
                                 <div class="form-floating">
                                    <input type="text" class="form-control" id="editIntroduction" placeholder="" />                              
                                 </div>                            
...
<script src="assets/vendor/libs/flatpickr/flatpickr.js"></script>
  ...
  <script>
    $('#submit').on('click',function(){ 
      if(globalEditor){
        var introduction=globalEditor.getData();
      }
 
      if(!introduction ){
        $('.formErrorMessage').html("please fill this above details to continue !");
      }else{      
      ...
      $('.edit').click(function(){
         ...
         $.ajax({
            type: "POST", 
            dataType: "json", 
            url: "xhr/fetch-introduction", 
            data: {
               dataId:dataId         
            },
            success: function(response){      
            if(globalEditor2){
               globalEditor2.setData(response.introduction);
            }            
            },
            error: function(error){
                  console.log("Error:");
      ...
      var id=$('#ModalID').val();
      if(globalEditor2){
         var introduction=globalEditor2.getData();
      }

      if(!introduction){
         $('#updateErrorMessage').html("please fill this above details to continue !");
      }else{
