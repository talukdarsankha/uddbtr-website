...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        initializeCKEditor("#uddInformation", "globalEditor");
        initializeCKEditor("#editUddInformation", "globalEditor2");
    });
</script>
            ...
            <div class="content-wrapper">
               ...
               <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="modal-dialog">
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="backDropModalTitle">Add Organization Information</h5>
                                ...
                                <div class="modal-body">   
                                    ...
                                    <label for="uddInformation">Information About UDD</label>
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="uddInformation" placeholder="" />                              
                                    </div>                             
                  ...
                  <div class="card" style="margin-top: 20px">
                     <div class="card-header border-bottom">
                        <h5 class="card-title">View Organization Information</h5>
                     </div>
                        ...
                        <table id="example" class="datatables-users"style="width:100%; padding: 20px">
                           <thead>
                              <tr>
                                 ...
                                 <th>Image</th>
                                 <th>Pdf</th>
                                 <th>UDD Information</th>                                                          
                                 <th>Action</th>                              
                              </tr>
                           </thead>
                           <tbody>
                              <?php 
                                 $organization_info = $crud->Read('organization_info',"1 order by `id` desc"); 
                                 if ($organization_info) {
                                   $n=0;
                                   foreach($organization_info as $info){
                                 ?>
                              <tr>
                                 <td><?php echo ++$n; ?></td>
                                 ...
                                 <td style="text-align:justify;"><?php echo $info['udd_information']; ?></td>
                                 <td>
               ...
               <div class="modal fade" id="backDropModal2" data-bs-backdrop="static" tabindex="-1">
                        <div class="modal-dialog">
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="backDropModalTitle">Edit Organization Information</h5>
                                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              <div class="form-floating d-none">
                                ...
                                <div class="modal-body">   
                                    ...
                                    <label for="editUddInformation">Information About UDD</label>
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="editUddInformation" placeholder="" />                              
                                    </div>                             
...
<script src="assets/vendor/libs/flatpickr/flatpickr.js"></script>
  ...
  <script>
    $('#submit').on('click',function(){ 
      if(globalEditor){
        var uddInformation=globalEditor.getData();
      }
      ...
      if(!uddInformation || !image || !pdf || !chosenImage || !chosenPdf){
        ...
        formData.append("uddInformation",uddInformation);
      ...
      $('.edit').click(function(){
         ...
         $.ajax({
            type: "POST", 
            dataType: "json", 
            url: "xhr/fetch-organization-info", 
            data: {
               dataId:dataId         
            },
            success: function(response){      
            if(globalEditor2){
               globalEditor2.setData(response.udd_information);
            }
      ...
      if(globalEditor2){
         var udd_information=globalEditor2.getData();
      }

      if(!chosenImage || !chosenPdf || !udd_information){
         ...
         formData.append('image',image);
         formData.append('pdf',pdf);
         formData.append('udd_information',udd_information);
         ...
         cache: false,
         dataType: "json",
         url: "xhr/edit-organization-info",
         mimeType: 'multipart/form-data',
         data: formData,
         success: function(response){
            if(response.successMessage){
      ...
      $.ajax({
         type:"post",
         dataType:"json",
         url:"xhr/delete-organization-info",
         data:{dataId:id},
         success: function(response){
            if(response.successMessage){
                  $("#backDropModal2").css("display", "none");
