            ...
            <div class="content-wrapper">
               ...
               <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="modal-dialog">
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="backDropModalTitle">Add Chair Person's Message</h5>
                  ...
                  <div class="card" style="margin-top: 20px">
                     <div class="card-header border-bottom">
                        <h5 class="card-title">View Chair Person's Message</h5>
                     </div>
                     <div class="card-datatable table-responsive" style="padding: 20px">
                        <table id="example" class="datatables-users"style="width:100%; padding: 20px">
                           ...
                           <tbody>
                              <?php 
                                 $chairPersonMessages = $crud->Read('chair_person_message',"1 order by `id` desc"); 
                                 if ($chairPersonMessages) {
                                   $n=0;
                                   foreach($chairPersonMessages as $message){
                                 ?>
                              <tr>
                                 <td><?php echo ++$n; ?></td>
               ...
               <div class="modal fade" id="backDropModal2" data-bs-backdrop="static" tabindex="-1">
                        <div class="modal-dialog">
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="backDropModalTitle">Edit Chair Person's Message</h5>
                                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
    ...
    $('#submit').on('click',function(){ 
      ...
      if(!image || !name || !message){
        ...
        $.ajax({
          ...
          dataType: "json",
          url: "xhr/add-chair-person-message",        
          data: formData,
      ...
      $('.edit').click(function(){
         ...
         $.ajax({
            type: "POST", 
            dataType: "json", 
            url: "xhr/fetch-chair-person-message", 
            data: {
               dataId:dataId         
            },
            success: function(response){      
      ...
      if(!name || !message || !chosenImage){
         ...
         cache: false,
         dataType: "json",
         url: "xhr/edit-chair-person-message",
         mimeType: 'multipart/form-data',
         data: formData,
         success: function(response){
            if(response.successMessage){
      ...
      $.ajax({
         type:"post",
         dataType:"json",
         url:"xhr/delete-chair-person-message",
         data:{dataId:id},
         success: function(response){
            if(response.successMessage){
                  $("#backDropModal2").css("display", "none");
