...
<div class="authentication-wrapper authentication-cover">
  <div class="authentication-inner row m-0">
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4" style="background-color: #f9ffff;">
      <div class="w-px-400 mx-auto">
        ...
        <div class="app-brand mb-5">
            <img src="../../../assets/images/logo/logo.png" style="max-height: 10rem; max-width: 10rem;" class="responsive-img">
        </div>
    ...
    <div class="form-floating" id="password-text">
    ...
    <input class="btn btn-info" id="sent-otp" value="Sent OTP" type="button">
    <input class="btn btn-info" id="verify-otp" value="Verify OTP" type="button">
 ...
 <script src="assets/plugins/sweetalert/sweetalert.min.js"></script>
  ...
  <script type="text/javascript">
        ...
        $('#verify-otp').on('click', function () {
            ...
            if (userType===""||userType===null || MB===""||MB===null || Phone===""||Phone===null || OTP===""||OTP===null) {
                $("#formErrorMessage").html("Fill all the details to continue...");
              ...
              $("#formErrorMessage").html("");
                ...
                //     $("#phoneErrorMessage").html("");
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        dataType: "json", 
                        url: "login-process/user-login-process-test",
                        mimeType: 'multipart/form-data',
                        data: formData,
                        success: function(response){
                        if(response.successMessage){
                            ...
                            swal("Success!",response.successMessage+" Reloading", "success");
                               ...
                               // window.location.href = "login-process/user-login-process-test";
                          // $("#password-text").css("display","inline-block");
                          // $("#sent-otp").css("display","none");
