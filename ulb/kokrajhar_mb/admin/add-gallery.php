            ...
            <div class="content-wrapper">
               ...
               <div class="container-xxl flex-grow-1 container-p-y">
                  <div class="mt-3">
                     ...
                     <button type="button"  style="margin: 6px;" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#backDropModalMultiple">
                        Add Multiple 
                     </button>
                     <!-- Add Modal -->   
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                       <div class="form-floating selectStatus">
                                          <select class="form-select" id="category"  placeholder="select category" aria-label="Floating select example">
                                             <option selected disabled>Select</option>
                                             <option value="Event">Event</option>
                                             <option value="Culture">Culture</option>
                                             <option value="Local areas">Local areas</option>
                                             <option value="Development">Development</option>
                                             <option value="Planings">Planings</option>
                           ...
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              ...
                              <div class="modal-body">   
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                       <div class="form-floating">
                                          <select class="form-select" id="multiCategory"  placeholder="select category" aria-label="Floating select example">
                                             <option selected disabled>Select</option>
                                             <option value="Event">Event</option>
                                             <option value="Culture">Culture</option>
                                             <option value="Local areas">Local areas</option>
                                          ...
                                          <label for="multiCategory">Category</label>
                                       </div>
                                    </div>
                                </div>                                                         
                        ...
                        <section id="gallery">
                           <div class="container">
                              ...
                              <div class="d-flex justify-content-end">
                                 ...
                                 <button type="button" style="margin: 6px; display: none;" class="delete-images btn btn-danger">
                                    Delete 
                                 </button>
                              </div>
                              ...
                              <div class="images" id="itemList">
                                 ...
                                 <?php
                                    $galleryImgs=$crud->Read("gallery","1 order by `id` desc");
                                    if($galleryImgs){
                                       foreach($galleryImgs as $img){
                                 ?>

                                    <div class="img">
                                       <div class="top-sc d-flex justify-content-between p-1">
                                          <input type="checkbox" class="delete-checkbox" value="<?= $img['id']; ?>">
                                       ...
                                       <p><i class="fa-solid fa-camera-rotate"></i><?= $img['category']; ?></p>
                                    </div>                              
                                 <?php
                                       }
                                    }else{
                        ...
                        <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                            ...
                            <div class="modal-body">                               
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                       <div class="form-floating">
                                          <select class="form-select" id="editCategory"  placeholder="select category" aria-label="Floating select example">
                                             <option selected disabled>Select</option>
                                             <option value="Event">Event</option>
                                             <option value="Culture">Culture</option>
                                             <option value="Local areas">Local areas</option>
  ...
  <script>
    $('#submit').on('click',function(){ 
      ...
      if(images.length ===0 || !category){
        $('.multiFormErrorMessage').html("please fill all details to continue !");
        if(images.length ===0){
      ...
      $(document).ready(function() {
        ...
        // Check if the .selectall checkbox is checked
            if ($(this).is(':checked')) {
                  // Check all .delete-checkbox checkboxes
                  $('.delete-checkbox').prop('checked', true);

                  // Add all .delete-checkbox values to selectedValues
                  selectedValues = $('.delete-checkbox').map(function() {
                     return $(this).val();
                  }).get(); // .get() converts it to a standard array

                  $('.delete-images').show();
            } else {
                  // Uncheck all .delete-checkbox checkboxes
            ...
            console.log(selectedValues); // You can check the selected values in the console
         });
         ...
         $('.delete-images').click(function(e){
            if (selectedValues.length === 0) {
               ...
               if(confirm("do you want to delete this images ?")){
                     $.ajax({
                     type:"post",
                     dataType:"json",
                     url:"xhr/delete-multiple-gallery-images",
                     data:{imgIds:selectedValues},
                     success: function(response){
                        if(response.successMessage){
                              // $("#backDropModal2").css("display", "none");
                              // showSuccessMessage ();
