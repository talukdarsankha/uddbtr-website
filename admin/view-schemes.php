         ...
         <div class="layout-page">
            ...
            <div class="content-wrapper">
               ...
               <div class="container-xxl flex-grow-1 container-p-y" style="background-color: <?php echo $container_xxl_color;?>">
                  ...
                  <h4 class="py-3 mb-4">
                  <span style="text-transform: uppercase;"> View Scheme</span>
                </h4>
                  <div class="mt-3">
                  ...
                  <div class="card" style="margin-top: 20px">
                     <div class="card-header border-bottom">
                        <h5 class="card-title">View All Schemes </h5>
                     </div>
                        ...
                        <table id="example" class="datatables-users"style="width:100%; padding: 20px">
                           ...
                           <tbody>
                              ...
                              <tr>
                                ...
                                <td class="data">
                                  <a href="scheme-details?id=<?php echo $Id;?>"class="btn btn-info btn-buy-now btn-sm add-details">VIEW DETAILS</a>
                                </td>
                              ...
                              <div class="modal-body">
                                <div class="form-floating">
                                 ...
                                 <div class="form-floating">
                                      ...
                                      <label for="scheme_name">Scheme Details</label>
                                  </div>
                                  <div class="form-floating">
