         ...
         <div class="layout-page">
            ...
            <div class="content-wrapper">
               ...
               <div class="container-xxl flex-grow-1 container-p-y" style="background-color: <?php echo $container_xxl_color;?>">
                ...
                <h4 class="py-3 mb-4">
                  <span style="text-transform: uppercase;">Manage Scheme</span> 
                </h4>
                  <div class="mt-3">
                        ...
                        <div class="modal-dialog">
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="backDropModalTitle">ADD Scheme</h5>
                  ...
                  <div class="card" style="margin-top: 20px">
                     <div class="card-header border-bottom">
                        <h5 class="card-title">All Schemes </h5>
                     </div>
                     <div class="card-datatable table-responsive" style="padding: 20px">
                        <table id="example" class="datatables-users"style="width:100%; padding: 20px">
                           ...
                           <tbody>
                              <?php 
                                 $readUsers = $crud->Read('schemes',"1 order by `id` desc"); 
                                 if ($readUsers) {
                                   $n=0;
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <?php
                                      if($readKey['pdf']){ 
                                    ?>
                                        <a href="<?php echo $readKey['pdf'];?>" target="_blank"><img src="img/organizationInfo/pdfcover.png" style="width:40px;height:40px;"></a>
                                    <?php
                                      }
                                    ?>
                                 </td>
               ...
               <div class="modal fade" id="backDropModal2" data-bs-backdrop="static" tabindex="-1">
                        <div class="modal-dialog">
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="backDropModalTitle">Edit Schemes </h5>
                                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              <div class="modal-body">
                     ...
                     <div class="modal fade" id="backDropModal3" data-bs-backdrop="static" tabindex="-1">
                        <div class="modal-dialog">
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="backDropModalTitle">ADD Schemes Details </h5>
                                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              <div class="modal-body">
                                 ...
                                 <div class="form-floating">
                                  ...
                                  <div class="form-floating">
                                      <input type="number" min="0" max="100" class="form-control" name="scheme_progress" id="scheme_progress" placeholder=" ">                        
  ...
  <script type="text/javascript">
    $(function () {
        $('#add-scheme').on('click', function () {
            ...
            if (scheme_name===""||scheme_name===null || location===""||location===null || person===""||person===null || phone===""||phone===null || !pdf || !chosenPdf) {
    ...
    $(function () {
        $('#update-scheme').on('click', function () {
           ...
           console.log(scheme_id);
            ...
            if (schemename===""||schemename===null || scheme_id===""||scheme_id===null || location===""||location===null || person===""||person===null ||phone===""||phone===null || !chosenPdf) {
                $("#updateErrorMessage").html("Fill all the details to continue...");
              
                if(!chosenPdf){
                    $('#editPdfErrorMessage').html("select any pdf file .");
