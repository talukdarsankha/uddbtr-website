                        ...
                        <div class="modal-dialog">
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="backDropModalTitle">Add Users</h5>
                              ...
                              <div class="modal-body">
                                 ...
                                 <div class="form-floating">
                                    <input type="file" class="form-control" accept="image/*" name="image" name="phone" id="upload-button" placeholder=""  />
                        ...
                        <table id="example" class="datatables-users"style="width:100%; padding: 20px">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="data"><img src="<?php echo $readKey['user_image'];?>" style="max-width: 80px"></td>
                                 <td class="data"><?php echo $readKey['username'];?></td>
                                 <td class="data"><?php echo $readKey['email']; ?></td>
                                 <td class="data"><?php echo $readKey['phone']; ?></td>
                                 <td class="data"><?php echo ucfirst(str_replace('_mb', ' ', $readKey['MB'])); ?></td>
                        ...
                        <div class="modal-dialog">
                           <form class="modal-content" enctype="multipart/form-data" action="" method="post">
                              ...
                              <div class="modal-body">
                                 ...
                                 <div class="form-floating">
                                    <input type="text" class="form-control" name="edit_designation" id="edit_designation" placeholder=""  />
                                     <p id="emailErrorMessage" style="color:red"></p>
                                    <label for="floatingInput">Designation</label>
                                 </div>
                                  <div class="form-floating">
                                 ...
                                 <div class="form-floating">
                                    <input type="file" class="form-control" accept="image/*" name="image" id="aboutImage" placeholder=""  />
                                    <label for="floatingInput">Profile Image</label>
                                    <img id="responseImage" width="100px" height="100px">
                                 </div>
                                 <!-- <div class="form-group mb-1 col-sm-12 col-md-2">
                                      <figure class="image-container">
                                        <img id="chosen-image responseImage" class="image-style" width="100px" height="100px">
                                      </figure>
                                  </div> -->
...
$(function () {
        $('#add-user').on('click', function () {
            ...
            if (username===""||username===null || MB===""||MB===null || status===""||status===null || email===""||email===null || password===""||password===null || designation===""||designation===null  || phone===""||phone===null || userType===""|| userType===null || file===""|| file===null ) {
  ...
  readURL(this);
    ...
    $(function () {
        $('#update-user').on('click', function () {
            ...
            if (username===""||username===null ||designation===""||designation===null || email===""||email===null || phone===""||phone===null ||MB===""||MB===null ||status===""||status===null ||userType===""||userType===null ||file===""||file===null) {
