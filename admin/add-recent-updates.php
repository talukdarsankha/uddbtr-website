            ...
            <div class="content-wrapper">
               ...
               <div class="container-xxl flex-grow-1 container-p-y">
                  <div class="mt-3">
                     ...
                     <h4 class="py-3 mb-4">
                      <span class="text-muted fw-light"><?php if(isset($_SESSION['$userType'])){ echo $_SESSION['$userType'] .' / '; } ?> </span><span style="text-transform: uppercase;">Updates / Notices</span>
                     </h4>
       ...
       function handlePdfUpload(inputId, imageId) {
            ...
            uploadInput.onchange = () => {
                ...
                if (fileName.endsWith('.pdf')) {
                    ...
                    chosenImage.setAttribute("src", "img/others/empty.jpg");
      ...
      $('.edit').click(function(){
         ...
         $.ajax({
            ...
            if(response.pdf){
               ...
               $('#edit-chosen-pdf').attr("src","img/others/empty.jpg"); 
            } 
