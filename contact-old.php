    ...
    <main>
                            ...
                            <div class="info-table">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>CHD, Urban Development Department BTC, Kokrajhar</th>
                                            <td> Sri Lankeswar Owarie </td>
                                        </tr>
                                        <tr>
                                            <th>Deputy Director, Town and Country Planning, Kokrajhar</th>
                                            <td>Sri. Biren Swargiary</td>
                                        </tr>
                                        <tr>
                                            <th>Assistant Director, Town and Country Planning, Chirang</th>
                                            <td>Sri. Neepjyoti Das</td>
                                        </tr>
                                        <tr>
                                            <th>Assistant Director, Town and Country Planning, Baksa</th>
                                            <td>Smt. Trishna Gogoi</td>
                                        </tr>
                                        <tr>
                                            <th>Assistant Director, Town and Country Planning, Udalguri</th>
                                            <td>Sri. Santanu Das</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
       ...
       <div style="padding-left: 15px; padding-right: 15px;">
        ...
        <div class="brand-area" >
            <div class="container" style="max-width: 6000px !important;">
                <div class="swiper brandSwiper-active">
                    <div class="swiper-wrapper">

                      
                        <div class="swiper-slide">
                            <img style="max-width: 4600px !important; min-height: 70px !important; opacity: 1 !important;"
                             src="assets/images/style-images/aronai_pattern-removebg-preview.png" alt="UDD">
                        </div>
                        <div class="swiper-slide">
                            <img style="max-width: 4600px !important; min-height: 70px !important; opacity: 1 !important;"
                             src="assets/images/style-images/aronai_pattern-removebg-preview.png" alt="UDD">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.successMessage) {
                        swal("Success!", response.successMessage, "success").then(() => {
