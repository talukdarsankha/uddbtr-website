                            ...
                            <div class="main-profile">
                                    ...
                                    <div class="d-flex flex-column gap-10">
                                        <div class="user-img-lg">
                                            <img src="admin/<?= $chdMessage[0]['image'] ?>"
                                                alt="chairpersonPhoto">
                                        </div>

                                        <div>
                                            <p class="desg font-700 text-secondary"><?= $chdMessage[0]['name']; ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="user-info">
                                        ...
                                        <p style="text-align:justify">
                                            ...
                                            <span
                                                ...
                                                <a href="about-details?s=chdMessage" style="color: #fff;">READ MORE</a>
                                            </span>
                                        </p>
                        ...
                        <div class="mx-430 mb-30 p-3">
                            ...
                            <div class="d-flex align-items-center gap-10 mb-3" >
                                ...
                                <div class="form-container">
                                    <input type="text" value="recentUpdate" id="recentUpdate" hidden>

                                    <select class="select-box" id="district-select-notice">
                                        <option value="" selected>Select District</option>
                                        <option value="Kokrajhar">Kokrajhar</option>
                                    </select>
                                    
                                    <select class="select-box" id="ulb-select-notice">
                                        <option value="" selected>Select ULB</option>
                                    </select>
                                    
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1" style="font-size: 21px; color: #eceef2;"><i class="fa fa-search"></i></span>
                                        </div>
                                        <input type="text" id="search-input-notice"  class="form-control" placeholder="SEARCH" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <ul class="recent-news-list2" id="loading-spinner-notice" style="display:none;">
                                    <i class="fa fa-spinner fa-spin"></i> Loading...
                                </ul>
                                <!-- scheme ul  -->
                                <ul class="recent-news-list2" id="dynamic-notice" style="display: none;">
                                    <!-- Dynamic schemes will be displayed here -->
                                </ul>
                                <ul class="recent-news-list2" id="search-notice"></ul>                                
                        ...
                        <div class=" mx-430 mb-30 p-3">
                            ...
                            <div class="d-flex align-items-center gap-10 mb-3" >
                                ...
                                <div class="form-container">
                                    ...
                                    <select class="select-box" id="ulb-select">
                                        <option value="" selected>Select ULB</option>
                                    </select>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="search-input"  class="form-control" placeholder="SEARCH" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <ul class="recent-news-list2" id="loading-spinner" style="display:none;">
                                    <i class="fa fa-spinner fa-spin"></i> Loading...
                                </ul>
                                <!-- scheme ul  -->
                                <ul class="recent-news-list2" id="dynamic-schemes" style="display: none;">
                                    <!-- Dynamic schemes will be displayed here -->
                                </ul>
                                <ul class="recent-news-list2" id="search-results">
                                        <!-- search-results schemes will be displayed here -->
                                </ul>    
...
<style>
    ...
    <script>
        $(document).ready(function() {
            // Define ULB options for districts
            const ulbOptions = {
                'Kokrajhar': [
                    { name: 'Kokrajhar MB', value: 'kokrajhar_mb' }
                ],
                'district2': [
                    { name: 'ULB 2-1', value: 'ulb_2_1' },
                    { name: 'ULB 2-2', value: 'ulb_2_2' }
                ]
            };
            ...
            $('#district-select').change(function() {
                ...
                const $ulbSelect = $('#ulb-select');

                // Clear existing ULB options
                $ulbSelect.empty().append('<option value="">Select ULB</option>');

                // Populate ULBs based on selected district
                if (district && ulbOptions[district]) {
                    ulbOptions[district].forEach(function(ulb) {
                        $ulbSelect.append(`<option value="${ulb.value}">${ulb.name}</option>`);
                    });
                }else {
                    // Show default list if no ULB is selected
                    $('#search-results').hide();         
                    $('#dynamic-schemes').hide();    
                    $('#default-schemes').show();  
                    $.ajax({
                        url: 'xhr/fetch-default-scheme-all', // Adjust to the correct path
                        method: 'GET',                     
                        success: function(response) {                        
                            $('#default-schemes').html(response);                                  
                        },
            ...
            // Handle ULB selection change
            $('#ulb-select').change(function() {
                const selectedULB = $(this).val();
                // console.log(selectedULB);

                if (selectedULB) {
                    
                    $('#default-schemes').hide();
                    $('#search-results').hide();
                    $('#dynamic-schemes').show();
                    $('#loading-spinner').show(); // Make sure you have a loading spinner element in your HTML
                    // Fetch schemes based on selected ULB
                    $.ajax({
                        url: 'xhr/fetch-scheme-all', // Adjust to the correct path
                        method: 'POST',
                        data: { ulb: selectedULB },
                        success: function(response) {
                            $('#dynamic-schemes').html(response);                           
            ...
            $('#search-input').on('input', function() {
                ...
                var selectedULB = $('#ulb-select').val(); 
                ...
                if(query===""){   
                    ...
                    $('#default-schemes').show();  
                    $.ajax({
                        url: 'xhr/search-default-scheme', // Adjust to the correct path
                        method: 'POST',
                        data: { query: query, ulb: selectedULB }, // Include the selected ULB in the request data
                        success: function(response) {                        
                            $('#default-schemes').html(response);                                  
                        },
                        error: function(xhr, status, error) {
                    ...
                    $.ajax({
                        url: 'xhr/search-all-scheme', // Adjust to the correct path
                        method: 'POST',
                        data: { query: query, ulb: selectedULB }, // Include the selected ULB in the request data
                        success: function(response) {
                            $('#search-results').show();
            ...
            $('#district-select-notice').change(function() {
                const districtNotice = $(this).val();
                const $ulbSelectNotice = $('#ulb-select-notice');

                // Clear existing ULB options
                $ulbSelectNotice.empty().append('<option value="">Select ULB</option>');

                // Populate ULBs based on selected district
                if (districtNotice && ulbOptions[districtNotice]) {
                    ulbOptions[districtNotice].forEach(function(ulb) {
                        $ulbSelectNotice.append(`<option value="${ulb.value}">${ulb.name}</option>`);
                    });
                }else {
                    // Show default list if no ULB is selected
                    $('#search-notice').hide();         
                    ...
                    $('#default-notice').show();  
                    $.ajax({
                        url: 'xhr/fetch-default-updates-all', // Adjust to the correct path
                        method: 'GET',                     
                        success: function(response) {                        
                            $('#default-notice').html(response);                                  
                        },
                        error: function(xhr, status, error) {
                            console.error('AJAX error:', status, error);
                        }
            ...
            $('#ulb-select-notice').change(function() {
                const selectedULBNotice = $(this).val();
                // console.log(selectedULB);

                if (selectedULBNotice) {
                    
                    $('#default-notice').hide();
                    $('#search-notice').hide();
                    $('#dynamic-notice').show();
                    $('#loading-spinner-notice').show(); // Make sure you have a loading spinner element in your HTML
                    // Fetch schemes based on selected ULB
                    $.ajax({
                        url: 'xhr/fetch-recent-updates-all', // Adjust to the correct path
                        method: 'POST',
                        data: { ulb: selectedULBNotice },
                        success: function(response) {
                            $('#dynamic-notice').html(response);                           
                            $('#loading-spinner-notice').hide();                            
                        },
                        error: function(xhr, status, error) {
                            console.error('AJAX error:', status, error);
                        }
            ...
            $('#search-input-notice').on('input', function() {
                var query = $(this).val().trim();
                var selectedULB = $('#ulb-select-notice').val(); 
                ...
                if(query===""){   
                    ...
                    $('#default-notice').show();  
                    $.ajax({
                        url: 'xhr/search-default-updates', // Adjust to the correct path
                        method: 'POST',
                        data: { query: query, ulb: selectedULB }, // Include the selected ULB in the request data
                        success: function(response) {                        
                            $('#default-notice').html(response);                                  
                    ...
                    // Perform AJAX request to fetch search results
                    $.ajax({
                        url: 'xhr/search-all-updates', // Adjust to the correct path
                        method: 'POST',
                        data: { query: query, ulb: selectedULB }, // Include the selected ULB in the request data
                        success: function(response) {
                            $('#search-notice').show();
                            $('#search-notice').html(response);
                            $('#default-notice').hide();
                            $('#dynamic-notice').hide();                    
                        },
                        error: function(xhr, status, error) {
