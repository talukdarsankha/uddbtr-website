...
if(isset($_GET['ulb'])){
    $ulb=$_GET['ulb'];
    $decoded_ulb = urldecode($ulb); // Decode the URL-encoded string
    $cleaned_ulb = trim($decoded_ulb, " '");

    $crudFile = $baseDir . $cleaned_ulb . '/classes/Crud.php';

}else{
    $crudFile = 'classes/Crud.php'; 
}
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        ...
                        <div class="swiper h-calc testimonialTwo-active swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden">
                            <div class="swiper-wrapper bx-shd2">
                                <div class="swiper-slide testimonial-card-two h-calc swiper-slide-visible swiper-slide-fully-visible swiper-slide-active" style="background:none">
                                    <?php
                                    if ($schemeDetails) {
                                    ...
                                    <div class="faqs-area bottom-padding">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="pera t-justify user-qty-card text-justify bx-shd2" style="font-weight: normal;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                                                        <div class="row d-flex justify-content-between">
                                                            <div class="col-12 col-md-6 col-lg-6">
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <span><?php echo htmlspecialchars($s_details); ?></span>
                                                                </p>
                                                                <p>
                                                                    <strong>CONTRACTOR : </strong>
                                                                    <span><?php echo htmlspecialchars($s_contractor); ?></span>
                                                                </p>
                                                                
                                                                <p>
                                                                    <strong>LOCATION : </strong>
                                                                    <span><?php echo htmlspecialchars($s_location); ?></span>
                                                                </p>
                                                                <!--<p>-->
                                                            ...
                                                            <div class="col-12 col-md-6 col-lg-6">
                                                                ...
                                                                if ($s_progress == '100') {
                                                                    echo '<div class="progress">
                                                                            <div class="progress-bar completed" role="progressbar" style="width: ' . htmlspecialchars($s_progress) . '%; background-color: #0dee30; color: #0d0a0a; font-weight: 700;" aria-valuenow="' . htmlspecialchars($s_progress) . '" aria-valuemin="0" aria-valuemax="100">
                                                                    ...
                                                                    echo '<div class="progress">
                                                                            <div class="progress-bar" role="progressbar" style="width: ' . htmlspecialchars($s_progress) . '%;" aria-valuenow="' . htmlspecialchars($s_progress) . '" aria-valuemin="0" aria-valuemax="100">
                                                        ...
                                                        ?>
                                                          <div class="row mt-30">
                                                            <div class="imgs images col-12 d-flex flex-wrap gap-10 justify-content-around">
                                                                <div class="image-box">
                                                                    <img style="max-height: 180px; max-width: 150px; border-radius: 3%;" src="ulb/<?= $cleaned_ulb; ?>/admin/<?= $s_image1; ?>" alt="progress-image">
                                                                </div>
                                                                <div class="image-box">
                                                                    <img style="max-height: 180px; max-width: 150px; border-radius: 3%;" src="ulb/<?= $cleaned_ulb; ?>/admin/<?= $s_image2; ?>" alt="progress-image">
                                                                </div>
                                                                <div class="image-box">
                                                                    <img style="max-height: 180px; max-width: 150px; border-radius: 3%;" src="ulb/<?= $cleaned_ulb; ?>/admin/<?= $s_image3; ?>" alt="progress-image">
                                                                </div>
                                                            </div>
                                                          </div>
                                                        <?php
                                                        ...
                                                        ?>
                                                          <div class="row mt-30">
                                                            <div class="imgs images col-12 d-flex flex-wrap gap-10 justify-content-around">
                                                                <div class="image-box">
                                                                    <img style="max-height: 180px; max-width: 150px; border-radius: 3%;" src="admin/<?= $s_image1; ?>" alt="progress-image">
                                                                </div>
                                                                <div class="image-box">
                                                                    <img style="max-height: 180px; max-width: 150px; border-radius: 3%;" src="admin/<?= $s_image2; ?>" alt="progress-image">
                                                                </div>
                                                                <div class="image-box">
                                                                    <img style="max-height: 180px; max-width: 150px; border-radius: 3%;" src="admin/<?= $s_image3; ?>" alt="progress-image">
                                                                </div>
                                                            </div>
                                                          </div>
                                                        <?php
